...
public class CobblemonExtrasConfig {
    Gson GSON = new GsonBuilder()
            ...
            .setPrettyPrinting()
            .create();
    public static int COMMAND_POKETRADE_PERMISSION_LEVEL;
    public static int COMMAND_POKESEE_PERMISSION_LEVEL;
    public static int COMMAND_POKESEEOTHER_PERMISSION_LEVEL;
    public static int COMMAND_PC_PERMISSION_LEVEL;
    public static int COMMAND_POKESHOUT_PERMISSION_LEVEL;
    public static int COMMAND_COMPSEE_PERMISSION_LEVEL;
    public static int COMMAND_COMPSEEOTHER_PERMISSION_LEVEL;
